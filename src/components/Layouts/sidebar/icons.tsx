...
export function InvoiceIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
      ...
      {...props}
    >
      <path d="M7 9.75a.75.75 0 01.75-.75h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 017 9.75zM7 13.75a.75.75 0 01.75-.75h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 017 13.75zM7 17.75a.75.75 0 01.75-.75h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 017 17.75z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.25 2A.75.75 0 016 1.25h12a.75.75 0 01.75.75v20a.75.75 0 01-1.22.585L12 19.059l-5.53 3.526a.75.75 0 01-1.22-.585V2zm1.5.75v18.212l4.78-3.05a.75.75 0 01.84 0l4.78 3.05V2.75H6.75z"
      />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.25 8.75a.75.75 0 010-1.5h2a.75.75 0 01.75.75v2a.75.75 0 01-1.5 0V9.71l-2.47 2.47a.75.75 0 01-1.06-1.06l2.47-2.47H17.25z"
      />
    </svg>
  );
}

export function ApplianceIcon(props: PropsType) {
  return (<svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 10V13C4 16.7712 4 18.6569 5.17157 19.8284C6.34315 21 8.22876 21 12 21C15.7712 21 17.6569 21 18.8284 19.8284C20 18.6569 20 16.7712 20 13V10C20 6.22876 20 4.34315 18.8284 3.17157C17.6569 2 15.7712 2 12 2C8.22876 2 6.34315 2 5.17157 3.17157C4.51839 3.82475 4.22937 4.69989 4.10149 6" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M17 21V22H16V21M8 21V22H7V21" stroke="#1C274C" strokeWidth="1.5" strokeLinejoin="round"/>
    <path d="M20 11.5H15M4 11.5H11" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M17 7L17 9" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M17 14L17 16" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
